"""
claude-env :: Application - Audit Reporting - ComplianceReportGenerator

Compliance evidence reports read from the tamper-evident ledger via
IDatabase/IAuditRepository. Nothing leaves the machine unless the operator
exports the rendered output.
"""
